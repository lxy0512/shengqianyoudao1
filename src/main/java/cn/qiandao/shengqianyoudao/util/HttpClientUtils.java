...
public class HttpClientUtils {
    public static final int connTimeout = 10000;//连接超时
    public static final int readTimeout = 10000;//读取超时
    public static final String charset = "UTF-8";
    private static HttpClient client = null;//HTTP 协议的客户端编程工具包

    static {
        /**
         *  PoolingHttpClientConnectionManager是一个HttpClientConnection的连接池，
         * 可以为多线程提供并发请求服务。主要作用就是分配连接，回收连接等。
         * 同一个route的请求，会优先使用连接池提供的空闲长连接。
         * setMaxTotal整个连接池的最大连接数
         * setDefaultMaxPerRoute是每个route默认的最大连接数
         */
    ...
    /**
     * 创建 SSL连接
     *使用SSL方式获取qq第三方登录用户JSON信息串(https)
     * @return
